...
import ru.fav.starlight.data.repository.FeatureFlagRepositoryImpl
import ru.fav.starlight.data.repository.NasaImagesRepositoryImpl
import ru.fav.starlight.data.service.FirebaseCrashReportingService
import ru.fav.starlight.data.service.FirebaseRemoteConfigService
...
interface BinderModule {
    ...
    @Binds
    @Singleton
    fun bindFeatureFlagRepositoryToImpl(impl: FeatureFlagRepositoryImpl): FeatureFlagRepository
    ...
    @Binds
    @Singleton
    fun bindRemoteConfigServiceToImpl(impl: FirebaseRemoteConfigService): RemoteConfigService

    @Binds
    @Singleton
    fun bindCrashReportingServiceToImpl(impl: FirebaseCrashReportingService): CrashReportingService
