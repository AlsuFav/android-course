    ...
    private fun loadNasaImageDetails(date: String) {
        ...
        if (cachedData != null) {
            ...
            viewModelScope.launch {
                _effect.emit(DetailsEffect.ShowToast(resourceProvider.getString(R.string.details_from_cache)))
            }
            return
        }

        viewModelScope.launch {
            _effect.emit(DetailsEffect.ShowToast(resourceProvider.getString(R.string.details_from_api)))
            runCatching {
